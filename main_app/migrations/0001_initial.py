# Generated by Django 4.0.1 on 2022-04-19 19:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tourCategory', models.CharField(choices=[('Food Experience', 'food_experience'), ('Activities in Nature', 'activities_in_nature'), ('Drinking experience', 'drinking_experience'), ('Spiritual experience', 'spiritual_experience'), ('Sighseeing experience', 'sightseeing_experience')], max_length=50)),
                ('tourCity', models.CharField(max_length=255)),
                ('tourLocation', location_field.models.plain.PlainLocationField(max_length=63)),
