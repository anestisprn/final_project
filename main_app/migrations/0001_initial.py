# Generated by Django 4.0.1 on 2022-04-18 18:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userEmail', models.EmailField(max_length=254, verbose_name='Customer Email')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tourImage', models.ImageField(blank=True, null=True, upload_to='static/media/images/', verbose_name='Tour Title')),
                ('endUser', models.ManyToManyField(blank=True, related_name='tourExperiences', to='main_app.EndUser')),
                ('tourGuide', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='main_app.tourguide')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_email', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.enduser')),
                ('tourExperience', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='main_app.tourexperience', verbose_name='TourExperience')),
            ],
        ),
        migrations.CreateModel(
            name='Booking',
            fields=[
                ...
                ('orderDetail', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='main_app.orderdetail')),
